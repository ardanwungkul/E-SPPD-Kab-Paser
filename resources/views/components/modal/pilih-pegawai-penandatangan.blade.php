@props(['pegawai'])
<div id="pilih-pegawai-penandatangan" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow-sm">
            ...
            <div class="flex items-center justify-between px-4 py-2 border-b rounded-t border-gray-200">
                ...
                <button type="button"
                    ...
                    data-modal-hide="pilih-pegawai-penandatangan">
            ...
            <div class="px-4 py-2 space-y-4 pt-16">
                <div class="relative pb-20">
                    <div class="rounded-lg overflow-hidden shadow-lg border border-secondary-4">
                        <table id="tablePegawaiPenandatangan" class="text-sm hover stripe row-border datatable">
                            <thead class="bg-secondary-3 text-secondary-2 font-medium">
                                <tr>
                                    ...
                                    <td class="text-xs">Pangkat/Golongan</td>
                                    <td class="text-xs">TTD Default</td>
                                            ...
                                            <div class="flex justify-center items-center gap-3">
                                                <div>
                                                    <button type="button" data-id="{{ $item->id }}"
                                                        ...
                                                        class="flex items-center gap-1 bg-secondary-3 px-3 py-1 rounded-lg text-secondary-2 hover:bg-opacity-90 border border-secondary-4 shadow-lg button-pegawai-penandatangan-check">
            ...
            <div class="flex items-center justify-end px-4 py-2 border-t border-gray-200 rounded-b">
                <button data-modal-hide="pilih-pegawai-penandatangan" type="button"
                    id="close-button-pilih-pegawai-penandatangan"
