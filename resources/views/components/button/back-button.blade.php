@props(['route' => null])
<a href="{{ $route }}"
    class=" bg-red-500 hover:bg-opacity-80 text-white rounded-lg px-3 py-2 text-xs shadow-lg flex gap-1 items-center justify-center duration-300 whitespace-nowrap w-min font-medium">
