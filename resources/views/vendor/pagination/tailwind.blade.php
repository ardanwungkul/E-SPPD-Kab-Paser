    ...
    <nav role="navigation" aria-label="{{ __('Pagination Navigation') }}"
        ...
        <div class="flex justify-between flex-1 sm:hidden">
            @if ($paginator->onFirstPage())
                <span
                    class="relative inline-flex items-center px-4 py-2 text-sm font-medium text-gray-500 bg-white border border-gray-300 cursor-default leading-5 rounded-lg dark:text-gray-600 dark:bg-gray-800 dark:border-gray-600">
                    {!! __('Kembali') !!}
                </span>
            @else
            ...
            @else
                <span
                    class="relative inline-flex items-center px-4 py-2 ml-3 text-sm font-medium text-gray-500 bg-white border border-gray-300 cursor-default leading-5 rounded-lg dark:text-gray-600 dark:bg-gray-800 dark:border-gray-600">
                    {!! __('Selanjutnya') !!}
                </span>
            @endif
        </div>
        ...
        <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-center">
            {{-- <div>
                <p class="text-sm text-secondary-1 leading-5">
                    {!! __('Menampilkan') !!}
                ...
                <span class="relative z-0 inline-flex rtl:flex-row-reverse shadow-sm rounded-lg">
                    ...
                    @if ($paginator->onFirstPage())
                        <span aria-disabled="true" aria-label="{{ __('pagination.previous') }}">
                            <span
                                class="relative inline-flex items-center px-2 py-2 text-sm font-medium text-gray-500 bg-white border border-gray-300 cursor-default rounded-l-lg leading-5 dark:bg-gray-800 dark:border-gray-600"
                                aria-hidden="true">
                    ...
                    @else
                        <span aria-disabled="true" aria-label="{{ __('pagination.next') }}">
                            <span
                                class="relative inline-flex items-center px-2 py-2 -ml-px text-sm font-medium text-gray-500 bg-white border border-gray-300 cursor-default rounded-r-lg leading-5 dark:bg-gray-800 dark:border-gray-600"
                                aria-hidden="true">
                                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd"
                                        d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z"
