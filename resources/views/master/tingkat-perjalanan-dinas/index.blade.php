<x-app-layout>
    <x-slot name="header">
        Data Tingkat Perjalanan Dinas
    </x-slot>

    <x-container>
        <x-slot name="content">
            <div>
                <x-button.add-button :route="route('tingkat-perjalanan-dinas.create')" />
                        ...
                        <table id="datatable" class="text-sm hover stripe row-border">
                            ...
                            <tbody class="text-secondary-2">
                                @foreach ($data as $item)
                                    <tr class="text-xs">
                                        ...
                                        <td>
                                            <div class="flex justify-center items-center gap-3">
                                                <div>
                                                    <div>
                                                        <a href="{{ route('tingkat-perjalanan-dinas.edit', $item->id) }}"
                                    ...
                                    <x-modal.confirm-delete :id="$item->id" :name="'Data'" :action="route('tingkat-perjalanan-dinas.destroy', $item->id)" />
                                @endforeach
                            </tbody>
                        </table>
                    </div>
