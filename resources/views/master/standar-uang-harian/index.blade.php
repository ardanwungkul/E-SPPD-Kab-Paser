<x-app-layout>
    ...
    <x-container>
        <x-slot name="content">
            <div>
                <x-button.add-button :route="route('suh.create')" />
                        ...
                        <table id="datatable" class="text-sm hover stripe row-border">
                            <thead class="bg-secondary-3 text-secondary-2 font-medium">
                                <tr>
                                    ...
                                    <td class="text-xs">Uang Harian</td>
                                    <td class="text-xs">Batas Biaya Penginapan</td>
                                    <td class="text-xs">Jenis </td>
                                    <td class="text-xs">Tujuan</td>
                            ...
                            <tbody class="text-secondary-2">
                                @foreach ($data as $item)
                                    ...
                                    <x-modal.confirm-delete :id="$item->id" :name="'Data'" :action="route('suh.destroy', $item->id)" />
                                @endforeach
                            </tbody>
                        </table>
                    </div>
