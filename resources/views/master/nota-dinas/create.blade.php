                    ...
                    <div class="text-sm pt-3">
                        ...
                        <div>
                            <table class="table table-bordered w-full" id="dynamicTableLampiran">
                                <tr>
                                    <td class="p-1">
                                        <label for="lampiran[0][lampiran]">
                                            <div
                                                class="flex rounded-lg overflow-hidden text-xs h-[37.33px] border cursor-pointer">
                                                <div
                                                    class="bg-secondary-3 text-secondary-1 flex-none flex items-center px-2">
                                                    <p>Unggah Berkas</p>
                                                </div>
                                                <div class="w-full flex items-center px-3 line-clamp-1">
                                                    <p id="nama_file[0]" class="text-secondary-1"></p>
                                                </div>
                                            </div>
                                        </label>
                                        <input type="file" name="lampiran[0][lampiran]" id="lampiran[0][lampiran]"
                                            class="hidden"
                                            onchange="document.getElementById('nama_file[0]').textContent = this.files[0].name" />
                                    </td>
                                    <td class="p-1 w-[35.33px]">
    ...
    $(document).ready(function() {
        $("#addAddOns").click(function() {
            ...
            $("#dynamicTableLampiran").append(
                `<tr>
                    <td class="p-1">
                        <label for="lampiran[${iLampiran}][lampiran]">
                            <div class="flex rounded-lg overflow-hidden text-xs h-[37.33px] border cursor-pointer">
                                ...
                                <div class="w-full flex items-center px-3 line-clamp-1">
                                    <p id="nama_file[${iLampiran}]" class="text-secondary-1"></p>
                                </div>
                            </div>
                        </label>
                        <input type="file" name="lampiran[${iLampiran}][lampiran]" id="lampiran[${iLampiran}][lampiran]" class="hidden"
                        onchange="document.getElementById('nama_file[${iLampiran}]').textContent = this.files[0].name"/> 
                    </td>
                    <td class="p-1 w-[35.33px]">
                        <button type="button" class="text-secondary-2 border border-secondary-4 rounded shadow-sm focus:outline-none bg-secondary-3 hover:bg-opacity-80 inline-flex items-center px-3 py-2 text-sm font-medium text-center remove-tr">
                            -
                        </button>
                    </td>
                </tr>`
