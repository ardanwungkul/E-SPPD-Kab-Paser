<x-app-layout>
    ...
    {{-- <div class="mb-4 shadow-lg rounded-lg">
        <ol class="overflow-hidden rounded-lg border border-gray-200 text-gray-600 w-full grid grid-cols-4">
            <li class="flex items-center w-full">
                <p
                    class="flex h-10 items-center gap-1.5 bg-gradient-to-r from-gray-200 to-gray-100 px-4 transition w-full">
    ...
    <x-container>
        <x-slot name="content">
            <form action="{{ route('nota-dinas.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('POST')
                    ...
                    <div class="text-sm grid grid-cols-2 gap-y-3 gap-x-7">
                        <div class="space-y-3">
                            <div class="flex flex-col gap-1">
                                ...
                                <select name="program_kode" id="program_kode" class="text-sm rounded-lg select2"
                                    required>
                    ...
                    <div class="text-sm grid grid-cols-2 gap-y-3 gap-x-7 pt-3">
                        <div>
                            ...
                            <input name="nomor" id="nomor" type="text"
                                ...
                                placeholder="Masukkan Nomor Registrasi" value="{{ $nomor }}" required>
                        </div>
                        <div>
                        ...
                        <div class="col-span-2">
                            ...
                            <input type="text" name="perihal" id="perihal"
                                class="text-sm rounded-lg w-full border-gray-300"
                                placeholder="Masukkan Perihal Nota Dinas" required>
                        </div>
                        <div class="col-span-2">
                            <label for="isi" class="block mb-1">Isi</label>
                            <textarea name="isi" id="isi" class="text-sm rounded-lg w-full border-gray-300" rows="4" required></textarea>
                        </div>
                    </div>
                    <div class="text-sm pt-3">
                        <p>Lampiran</p>
                        <div>
                            <table class="table table-bordered w-full" id="dynamicTableLampiran">
                                <tr>
                                    <td class="p-1">
                                        <input type="file" name="lampiran[0][lampiran]"
                                            class="bg-gray-200 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 w-full"
                                            placeholder="Masukkan Nama Add Ons" />
                                    </td>
                                    <td class="p-1 w-16">
                                        <button type="button" name="add" id="addAddOns"
                                            class="text-secondary-2 border border-secondary-4 p-3 rounded shadow-sm focus:outline-none bg-secondary-3 hover:bg-opacity-80 inline-flex items-center px-5 py-2.5 text-sm font-medium text-center">+</button>
                                    </td>
                                </tr>
                            </table>
                        </div>
...
<script type="module">
    ...
    $(document).ready(function() {
        $("#addAddOns").click(function() {
            ++iLampiran;
            $("#dynamicTableLampiran").append(
                '<tr> <td class="p-1"> <input type="file" name="lampiran[' +
                iLampiran +
                '][lampiran]" class="bg-gray-200 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 w-full"/> </td><td class="p-1"><button type="button" class="text-secondary-2 border border-secondary-4 p-3 rounded shadow-sm focus:outline-none bg-secondary-3 hover:bg-opacity-80 inline-flex items-center px-5 py-2.5 text-sm font-medium text-center remove-tr">-</button></td></tr>'
            );
        });
