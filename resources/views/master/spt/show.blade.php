    ...
    <x-container>
        <x-slot name="content">
            <div class="divide-y">
                ...
                <div id="accordion-collapse-spt" data-accordion="collapse" class="py-3">
                    ...
                    <div id="accordion-collapse-nota-dinas-body-1" class="hidden"
                        ...
                        <div class="p-5 border border-gray-200 rounded-lg mt-1 divide-y">
                                    ...
                                    <tbody>
                                        <tr class="odd:bg-white even:bg-secondary-3/60">
                                            ...
                                            <td class="p-2 font-medium" colspan="4">
                                                {{ $spt->nota_dinas->program->kode }}
                                                -
                                                {{ $spt->nota_dinas->program->uraian }}
                                            </td>
                                        </tr>
                                        <tr class="odd:bg-white even:bg-secondary-3/60">
                                            <td class="p-2 font-light w-40">Kegiatan</td>
                                            <td class="p-2 font-medium" colspan="4">
                                                {{ $spt->nota_dinas->kegiatan->formatted_kode }}
                                                -
                                                {{ $spt->nota_dinas->kegiatan->uraian }}</td>
                                        </tr>
                                        <tr class="odd:bg-white even:bg-secondary-3/60">
                                            <td class="p-2 font-light w-40">Sub Kegiatan</td>
                                            <td class="p-2 font-medium" colspan="4">
                                                {{ $spt->nota_dinas->sub_kegiatan->formatted_kode }}
                                                - {{ $spt->nota_dinas->sub_kegiatan->uraian }}</td>
                                        </tr>
                                        <tr class="odd:bg-white even:bg-secondary-3/60">
                                            <td class="p-2 font-light w-40">{{ session('config')->judul }}</td>
                                            <td class="p-2 font-medium" colspan="2">
                                                {{ $spt->nota_dinas->bidang->uraian }}
                                            </td>
                                            <td class="p-2 font-light w-40">Sub {{ session('config')->judul }}</td>
                                            <td class="p-2 font-medium" colspan="2">
                                                {{ $spt->nota_dinas->sub_bidang->uraian }}</td>
                                        </tr>
                                        <tr class="odd:bg-white even:bg-secondary-3/60">
                                            <td class="p-2 font-light w-40">Jenis Perjalanan</td>
                                            <td class="p-2 font-medium" colspan="2">
                                                {{ $spt->nota_dinas->jenis_perjalanan->uraian }}</td>
                                            <td class="p-2 font-light w-40">Tahun</td>
                                            <td class="p-2 font-medium" colspan="2">{{ $spt->nota_dinas->tahun }}
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                                ...
                                <table class="w-full table-striped text-sm text-secondary-2">
                                    <tbody>
                                        <tr class="odd:bg-white even:bg-secondary-3/60">
                                            ...
                                            <td class="p-2 font-medium" colspan="4">{{ $spt->nota_dinas->nomor }}
                                            </td>
                                        </tr>
                                        <tr class="odd:bg-white even:bg-secondary-3/60">
                                            <td class="p-2 font-light w-40">Tanggal</td>
                                            <td class="p-2 font-medium" colspan="4">
                                                {{ \Carbon\Carbon::parse($spt->nota_dinas->tanggal)->format('d M Y') }}
                                            </td>
                                        </tr>
                                        <tr class="odd:bg-white even:bg-secondary-3/60">
                            ...
                            @if ($spt->nota_dinas->lampiran->count() > 0)
                                <div class="py-3">
                                    <table class="w-full table-striped text-sm text-secondary-2">
                                        <tbody>
                                            <tr class="odd:bg-white even:bg-secondary-3/60">
                                            ...
                                            @foreach ($spt->nota_dinas->lampiran as $lampiran)
                                                <tr class="odd:bg-white even:bg-secondary-3/60">
                                    ...
                                    <table class="w-full table-striped text-sm text-secondary-2">
                                        <tbody>
                                            ...
                                            <tr class="odd:bg-white even:bg-secondary-3/60">
                                                ...
                                                <td class="p-2 font-medium" colspan="4">
                                                    <a href="{{ asset('storage/' . $spt->nota_dinas->disposisi->lampiran) }}"
                                            ...
                                            <tr class="odd:bg-white even:bg-secondary-3/60">
                                                ...
                                                <td class="p-2 font-medium" colspan="4">
                                                    {{ $spt->nota_dinas->disposisi->keterangan }}
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
