<x-app-layout>
    ...
    <x-container>
        <x-slot name="content">
            <div>
                <x-button.add-button :route="route('sub-bidang.create')" />
                                ...
                                @foreach ($data as $item)
                                    ...
                                    @if ($item->sub_bidang->count() > 0)
                                        @foreach ($item->sub_bidang as $sub_bidang)
                                            ...
                                            <x-modal.confirm-delete :id="$sub_bidang->id" :name="'Data'"
                                                :action="route('sub-bidang.destroy', $sub_bidang->id)" />
                                        @endforeach
                                    @endif
                                @endforeach
                            </tbody>
