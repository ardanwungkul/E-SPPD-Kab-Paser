        ...
        <x-slot name="content">
            <div>
                <div class="flex md:flex-row flex-col md:items-center justify-between">
                    <x-button.add-button :route="route('kabupaten-kota.create')" />
                        ...
                        <table id="datatable" class="text-sm hover stripe row-border">
                            ...
                            <tbody class="text-secondary-2">
                                @foreach ($data as $item)
                                    <tr class="text-xs">
                                        ...
                                        <td>
                                            <div class="flex justify-center items-center gap-3">
                                                <div>
                                                    <div>
                                                        <a href="{{ route('kabupaten-kota.edit', $item->id) }}"
                                    ...
                                    <x-modal.confirm-delete :id="$item->id" :name="'Data'" :action="route('kabupaten-kota.destroy', $item->id)" />
                                @endforeach
                            </tbody>
                        </table>
                    </div>
