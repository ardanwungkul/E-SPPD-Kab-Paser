    ...
    <x-container>
        <x-slot name="content">
            <form action="{{ route('preferensi.store') }}" method="POST">
                ...
                @method('POST')
                <div class="space-y-5">
                    <fieldset class="border rounded-lg p-4 bg-gray-100 border-secondary-4 shadow-md">
                        <legend align="center" class="px-5 text-secondary-1 bg-white rounded-lg border text-sm">Sistem
                        </legend>
                        <div class="space-y-5">
                    ...
                    <fieldset class="border rounded-lg p-4 bg-gray-100 border-secondary-4 shadow-md">
                        <legend align="center" class="px-5 text-secondary-1 bg-white rounded-lg border text-sm">Profil
                            Instansi
                        </legend>
                        <div class="pt-3">
                            <div class="text-sm space-y-3">
                                <div class="text-sm space-y-3">
                                    <div class="flex flex-col gap-1">
                                        ...
                                        <input type="text" id="instansi_nama" name="instansi_nama"
                                            class="text-sm rounded-lg border border-gray-300"
                                            value="{{ $preferensi->instansi_nama }}" placeholder="Nama Instansi"
                                            required>
                                    </div>
                                </div>
                                <div class="text-sm space-y-3">
                                    <div class="flex flex-col gap-1">
                                        ...
                                        <input type="text" id="instansi_pemerintah" name="instansi_pemerintah"
                                            class="text-sm rounded-lg border border-gray-300"
                                            value="{{ $preferensi->instansi_pemerintah }}"
                                            placeholder="instansi Pemerintah" required>
                                    </div>
                                </div>
                                <div class="text-sm space-y-3">
                                    <div class="flex flex-col gap-1">
                                ...
                                <div class="text-sm space-y-3">
                                    <div class="flex flex-col gap-1">
                                        ...
                                        <input type="text" id="instansi_kontak_telp" name="instansi_kontak_telp"
                                            class="text-sm rounded-lg border border-gray-300"
                                            value="{{ $preferensi->instansi_kontak_telp }}"
                                            placeholder="Telpon Instansi" required>
                                    </div>
                                </div>
                                <div class="text-sm space-y-3">
                                    <div class="flex flex-col gap-1">
                    ...
                    <div class="flex justify-end items-center gap-4">
                        <button
                            class="bg-secondary-3 hover:bg-opacity-80 text-secondary-1 py-2 px-5 rounded-lg border border-secondary-4 flex items-center gap-1 text-sm"
                            type="submit">
    ...
    <x-container>
        <x-slot name="content">
            <form action="{{ route('config.store') }}" method="POST">
                ...
                <div class="space-y-5">
                    <fieldset class="border rounded-lg p-4 bg-gray-100 border-secondary-4 shadow-md">
                        <legend align="center" class="px-5 text-secondary-1 bg-white rounded-lg border text-sm">Format
                            Penomoran
                        </legend>
                        <div class="pt-3">
                    ...
                    <fieldset class="border rounded-lg p-4 bg-gray-100 border-secondary-4 shadow-md">
                        <legend align="center" class="px-5 text-secondary-1 bg-white rounded-lg border text-sm">Judul
                            Bagian/Bidang
                        </legend>
                        <div class="pt-3">
                            <div class="text-sm space-y-3">
