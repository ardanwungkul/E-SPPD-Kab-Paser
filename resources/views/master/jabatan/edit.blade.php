                ...
                <div class="text-sm space-y-3">
                    <div class="flex flex-col gap-1">
                        ...
                        <input type="text" id="uraian" name="uraian"
                            class="text-sm rounded-lg border border-gray-300" value="{{ $jabatan->uraian }}"
                            placeholder="Masukkan Uraian" required>
                    </div>
                    <div class="flex items-center gap-1">
                        <input type="checkbox" id="ttd_default" name="ttd_default"
                            {{ $jabatan->ttd_default == 'Y' ? 'checked' : '' }}
                            class="text-sm rounded-lg border border-gray-300" placeholder="Masukkan Uraian">
                        <label for="ttd_default">TTD Default</label>
                    </div>
