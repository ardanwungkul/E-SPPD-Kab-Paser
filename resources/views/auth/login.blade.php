<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login.store') }}" class="space-y-4">
        ...
        <div>
            ...
            <div class="flex shadow-md border border-gray-300 rounded-lg">
                ...
                <input type="text" id="username_or_email" name="username_or_email" autocomplete="username" required
                    value="{{ old('username_or_email') }}" placeholder="Username atau Email" class="block w-full rounded-r-lg text-sm border-none">
            </div>
        ...
        <div class="pt-4">
            <button
                class="bg-color-1-500 hover:bg-opacity-80 transition-colors duration-300 px-10 py-1 text-white rounded-lg shadow-lg text-sm w-full h-[37.33px]">Masuk</button>
        </div>
    </form>
</x-guest-layout>
