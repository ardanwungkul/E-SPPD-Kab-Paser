...
class AnggaranController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $sub_kegiatan->rp_pagu1= preg_replace('/[^0-9-]/', '', $request->rp_pagu1);
        $sub_kegiatan->rp_pagu2= preg_replace('/[^0-9-]/', '', $request->rp_pagu2);
        $sub_kegiatan->rp_pagu3= preg_replace('/[^0-9-]/', '', $request->rp_pagu3);
